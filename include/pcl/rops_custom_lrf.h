#ifndef REGISTRATION_ROPS_CUSTOM_LRF_H
#define REGISTRATION_ROPS_CUSTOM_LRF_H
...
class ROPSEstimationWithLocalReferenceFrames : public pcl::Feature<PointInT, PointOutT>,
                                               public pcl::FeatureWithLocalReferenceFrames<PointInT, PointRFT> {
public:
    ...
    using pcl::Feature<PointInT, PointOutT>::tree_;
...
public:
    ...
    ROPSEstimationWithLocalReferenceFrames();
...
private:
    ...
    /** \brief This method translates the cloud so that the given point becomes the origin.
      ...
      */
    void
    transformCloud(const PointInT &point, const Eigen::Matrix3f &matrix, const pcl::Indices &local_points,
                   PointCloudIn &transformed_cloud) const;
    ...
    /** \brief This method projects the local surface onto the XY, XZ or YZ plane
      ...
      */
    void
    getDistributionMatrix(const unsigned int projection, const Eigen::Vector3f &min, const Eigen::Vector3f &max,
